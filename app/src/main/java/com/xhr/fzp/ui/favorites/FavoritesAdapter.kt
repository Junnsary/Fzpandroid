...
class FavoritesAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoritesHolder {
        return FavoritesHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_favorites, parent, false))
    }
    ...
    override fun onBindViewHolder(holder: FavoritesHolder, position: Int) {
        ...
        if (favorites.tag.type == "article") {
            ...
            useGlideSetImage(fragment, FzpServiceCreator.getArticleImageURL(favorites.source.cover), holder.cover)
        } else {
            holder.itemView.setOnClickListener {
            ...
            useGlideSetImage(fragment, FzpServiceCreator.getVideoImageURL(favorites.source.cover), holder.cover)
        }
        holder.date.text = favorites.createdAt.toString()
